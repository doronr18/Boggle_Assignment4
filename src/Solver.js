 ...
 */
 ...
 const isPrefixOrWord = function(word, hash) {
    return hash[word] != undefined;
 }
 


 const findWords = function(word, y, x, grid, visited, hash, solutionSet){
...
const convertCaseToLower = function(grid, dict){
...
const isGridValid = function(grid){
 ...
 export default function fas(grid, dictionary){
    let solutions = [];
